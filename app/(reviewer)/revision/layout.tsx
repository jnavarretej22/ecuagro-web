...
import styles from "./revision-layout.module.css";
  ...
  return (
    <div className={styles.shell}>
      <header className={styles.header}>
        <Link href="/revision/analisis" className={styles.logoWrap}>
          ...
          <div>
            ...
            <span className={styles.logoPill}>Revisión</span>
          </div>
        </Link>

        <nav className={styles.nav}>
          <Link className={styles.navLink} href="/revision/analisis">
            Todos los análisis
          </Link>
